...
This is a content repository, not a deployed application.

Prioritize:
- malicious or deceptive link schemes, Markdown/HTML injection, and contributor-controlled active content;
- GitHub Actions or contribution automation that could execute untrusted input or expose tokens;
